...
public class ItemColourfulBucketFull extends ItemFluidContainer {
	...
	private boolean isEnchanted;
	  ...
	  public ItemColourfulBucketFull(boolean setIsEnchanted, boolean setIsMixed, boolean setIsFull)
	  {
		  super(1);
